...
function N(t) {
    ((!t.__d && (t.__d = !0) && h.push(t) && !E.__r++) ||
        f !== l.debounceRendering) &&
        ((f = l.debounceRendering) || setTimeout)(E);
}
function E() {
    for (var t; (E.__r = h.length); )
        ...
        if (
            ...
            U(t, f, (h = h || _), i, o, s, a, u, l),
                ...
                null != d
                    ...
                    : u && h.__e == u && u.parentNode != t && (u = P(h));
        }
    for (n.__e = g, c = b; c--; )
        null != y[c] &&
...
function L(t, e, n, r, i) {
    ...
    t: if ("style" === e)
        ...
        (o = e !== (e = e.replace(/Capture$/, ""))),
            ...
            (t.l[e + o] = n),
            n
                ? r || t.addEventListener(e, o ? I : A, o)
                : t.removeEventListener(e, o ? I : A, o);
        ...
        t: if ("function" == typeof x) {
            if (
                ...
                null != x.getDerivedStateFromProps &&
                    ...
                    v(p.__s, x.getDerivedStateFromProps(g, p.__s))),
                (f = p.props),
                (d = p.state),
                h)
            )
            ...
            (p.state = p.__s),
                ...
                (P =
                    null != c && c.type === S && null == c.key
                        ? c.props.children
                        : c),
                F(t, Array.isArray(P) ? P : [P], e, n, r, i, o, s, a, u),
                (p.base = e.__e),
                (e.__h = null),
                p.__h.length && s.push(p),
                m && (p.__E = p.__ = null),
        ...
        a ||
            ("value" in f &&
                ...
                (m !== t.value ||
                    ("progress" === d && !m) ||
                    ("option" === d && m !== h.value)) &&
                L(t, "value", m, h.value, !1),
            "checked" in f &&
                void 0 !== (m = f.checked) &&
                m !== t.checked &&
                L(t, "checked", m, h.checked, !1));
    }
    return t;
}
function O(t, e, n) {
...
var ft = /*#__PURE__*/ (function () {
        ...
        return (
            ...
            (e.remove = function (t) {
                return (
                    this.plugins.splice(this.plugins.indexOf(this.get(t)), 1),
                    this
                );
            }),
            (e.list = function (t) {
                ...
                if (this.props.pluginId) {
                    ...
                    return e
                        ? b(
                              ...
                              b(
                                  e.component,
                                  n({ plugin: e }, e.props, this.props.props)
                              )
                          )
                        : null;
                }
                    ...
                    ? b(
                          ...
                          this.config.plugin
                              ...
                              .map(function (e) {
                                  return b(
                                      e.component,
                                      n({ plugin: e }, e.props, t.props.props)
                                  );
                              })
                      )
                    : null;
                ...
                e.enabled &&
                    ...
                    (i = e.server
                        ...
                        : new nt({
                              keyword: e.keyword,
                              columns:
                                  r.config.header && r.config.header.columns,
                              ignoreHiddenColumns:
            ...
            (n.render = function () {
                ...
                return (
                    ...
                    b(
                        ...
                        {
                            className: rt(
                                it("search", this.config.className.search)
                            ),
                        },
                        b("input", {
                            type: "search",
                    ...
                    this.props.summary &&
                        ...
                        b(
                            ...
                            b(
                                ...
                                this._(
                                    "" +
                                        (this.state.page * this.state.limit + 1)
                                )
                            ),
                            " ",
...
var St = /*#__PURE__*/ (function (t) {
        function i() {
            var e;
            return (
                ((e = t.call(this) || this)._columns = void 0),
                (e._columns = []),
                e
            );
        }
        ...
        return (
            ...
            (o.setID = function (t) {
                for (var e, n = a(t || this.columns || []); !(e = n()).done; ) {
                    var r = e.value;
                    r.id || "string" != typeof r.name || (r.id = kt(r.name)),
                        r.id ||
                            pt.error(
            ...
            (i.fromColumns = function (t) {
                for (var e, n = new i(), r = a(t); !(e = r()).done; ) {
                    var o = e.value;
                    if ("string" == typeof o || p(o))
                        n.columns.push({ name: o });
                    else if ("object" == typeof o) {
                        var s = o;
                        s.columns &&
                            (s.columns = i.fromColumns(s.columns).columns),
            ...
            e(n, [
                {
                    ...
                    get: function () {
                        for (
                            var t,
                                e = [],
                                n = a(this.getSortedProcessorTypes());
                            !(t = n()).done;
        ...
        return (
            ...
            (t.fromUserConfig = function (e) {
                ...
                return (
                    ...
                    r.assign({ storage: Et.createFromUserConfig(e) }),
...
var Wt,
    ...
    Kt = /*#__PURE__*/ (function (t) {
        ...
        return (
            ...
            (i.compareWrapper = function (t, e) {
                for (
                    var n, r = 0, i = a(this.props.columns);
                    !(n = i()).done;
    ...
    ie = /*#__PURE__*/ (function (t) {
        function e(e, n) {
            var r;
            return (
                ((r = t.call(this, e, n) || this).headerRef = {
                    current: null,
                }),
                (r.state = { isActive: !0 }),
                r
    ...
    oe = /*#__PURE__*/ (function (t) {
        function e(e, n) {
            var r;
            return (
                ((r = t.call(this, e, n) || this).footerRef = {
                    current: null,
                }),
                (r.state = { isActive: !0 }),
                r
    ...
    se = /*#__PURE__*/ (function (t) {
        ...
        return (
            (i.processPipeline = function () {
                try {
                    ...
                    t.props.config.eventEmitter.emit("beforeLoad"),
                        t.setState({ status: Lt.Loading });
                    var e = (function (e, n) {
                        try {
                            var r = Promise.resolve(
                                t.props.pipeline.process()
                            ).then(function (e) {
                                t.setState({ data: e, status: Lt.Loaded }),
                        ...
                        pt.error(e),
                            t.setState({ status: Lt.Error, data: null });
                    });
                    return Promise.resolve(
            ...
            (i.componentDidUpdate = function (t, e) {
                e.status != Lt.Rendered &&
                    this.state.status == Lt.Loaded &&
                    (this.setState({ status: Lt.Rendered }),
            ...
            (i.render = function () {
                return b(
                    ...
                    b(
                        ...
                        this.state.status === Lt.Loading &&
                            b("div", { className: rt("loading-bar") }),
                        b(ie, null),
                        b(
                            "div",
                            {
    ...
    (l.__r = function (t) {
        ...
        e &&
            (zt === Bt
                ...
                : (e.__h.forEach(we), e.__h.forEach(ke), (e.__h = []))),
            (zt = Bt);
    }),
    (l.diffed = function (t) {
        fe && fe(t);
        ...
        e &&
            e.__H &&
            (e.__H.__h.length &&
                ((1 !== le.push(e) && qt === l.requestAnimationFrame) ||
                    (
                        (qt = l.requestAnimationFrame) ||
                        function (t) {
                            var e,
                                n = function () {
                                    clearTimeout(r),
